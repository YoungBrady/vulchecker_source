...
def del_ctrl_edge_exp_startnode(pdg, startnodeID):
    i = 0
    while i < pdg.ecount():
        if pdg.es[i]['var'] == None and pdg.vs[pdg.es[i].tuple[0]]['name'] not in startnodeID:
            pdg.delete_edges(i)
        else:
            i += 1
